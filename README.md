...
&nbsp;&nbsp;&nbsp;&nbsp;-I  ID - short, human-readable description of the certificate (No Longer Optional)<br>
&nbsp;&nbsp;&nbsp;&nbsp;-V <Validity_Time> - This (optional) flag gives an expiration date of the Host's SSH Certificate.  +52w is used as an example<br>
&nbsp;&nbsp;&nbsp;&nbsp;-z - Unique Serial Number generated by running this command which gives current epoch time in milliseconds: date +%s%3N<br>
